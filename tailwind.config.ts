    ...
    extend: {
      colors: {
        ju: {
          ...
          deep: "#0066FF",
          green: "#39FF14",
          magenta: "var(--ju-magenta, #FF2D95)",
          purple: "var(--ju-purple, #7B2CFF)",
          bgPurple: "var(--ju-bg-mid, #0D0221)",
          midnight: "var(--ju-bg-nav, #050A30)",
          space: "var(--ju-gradient-end, #02020F)",
          cyanGlow: "var(--ju-cyan-glow, #00F5FF)",
          pinkGlow: "var(--ju-pink-glow, #FF00E5)",
          limeGlow: "#66FF00",
          purpleGlow: "#A259FF",
          white: "#FFFFFF",
          soft: "#EAEAEA",
